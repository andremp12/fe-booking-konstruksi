<template>
  <div class="sticky top-0 z-40">
            <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
              ...
              <div class="flex">
                ...
                <!-- <div class="relative text-gray-600">
                  <h1 class="font-semibold text-gray-800 text-2xl">{{ $route.meta?.page }}</h1>
                </div> -->
            ...
            <!-- dropdown menu -->
            <div class="absolute bg-gray-100 border border-t-0 shadow-xl text-gray-700 rounded-b-lg w-48 bottom-40 right-0 mr-6" :class="dropDownOpen ? '' : 'hidden'">
