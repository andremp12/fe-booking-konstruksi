<template>
    <nav class="fixed w-full z-50 p-4">
      <div class="max-w-screen-xl rounded-full shadow-md bg-white bg-opacity-60 flex flex-wrap items-center justify-between mx-auto p-4 px-8">
      ...
      <div class="flex items-center md:order-2 space-x-3 md:space-x-0">
        <nuxt-link to="/login">
          <UButton color="primary" label="login" />
        </nuxt-link>
      </div>
