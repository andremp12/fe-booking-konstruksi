      ...
      <div class="w-full flex-1">
        <UTable
          ...
          <template #name-data="{row}">
            <div class="font-medium text-gray-600 ">{{ row.name }}</div>
            <div class="font-normal text-xs text-gray-600 ">{{ row.email }}</div>
          </template>
          <template #no_wa-data="{row}">
            <div v-if="row.no_wa">
              <div class="font-medium text-gray-600 ">{{ row.no_wa }}</div>
            </div>
